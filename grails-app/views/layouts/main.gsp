...
<div id="grailsLogo" role="banner">
    ...
    <div float="right" id="create-session" class="content scaffold-create" role="main">
        <g:form align="center" controller="Utilisateur" action="connect">
            <fieldset class="form">
                <g:render template="/layouts/form"/>
