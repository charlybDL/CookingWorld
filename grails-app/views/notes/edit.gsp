...
<html>
	...
	<body>
		...
		<div id="edit-notes" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${notesInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${notesInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:notesInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${notesInstance?.version}" />
				<fieldset class="form">
