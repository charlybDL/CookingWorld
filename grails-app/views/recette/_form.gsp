<%@ page import="cooking.world.Recette" %>
...
<div class="fieldcontain ${hasErrors(bean: recetteInstance, field: 'photo', 'error')} ">
	...
	<g:textField name="photo" value="${recetteInstance?.photo}"/>
...
<div class="fieldcontain ${hasErrors(bean: recetteInstance, field: 'ingredients', 'error')} required">
	...
	<g:textField name="ingredients" required="" value="${recetteInstance?.ingredients}"/>
...
<div class="fieldcontain ${hasErrors(bean: recetteInstance, field: 'description', 'error')} required">
	...
	<g:textField name="description" required="" value="${recetteInstance?.description}"/>
...
<div class="fieldcontain ${hasErrors(bean: recetteInstance, field: 'tempsPreparation', 'error')} required">
	...
	<g:field name="tempsPreparation" type="number" min="1" value="${recetteInstance.tempsPreparation}" required=""/>
...
<li class="add">
<g:link controller="commentaire" action="create" params="['recette.id': recetteInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'commentaire.label', default: 'Commentaire')])}</g:link>
</li>
</ul>
...
<li class="add">
<g:link controller="notes" action="create" params="['recette.id': recetteInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'notes.label', default: 'Notes')])}</g:link>
</li>
</ul>
...
<div class="fieldcontain ${hasErrors(bean: recetteInstance, field: 'utilisateur', 'error')} required">
	...
	<g:select id="utilisateur" name="utilisateur.id" from="${cooking.world.Utilisateur.list()}" optionKey="id" required="" value="${recetteInstance?.utilisateur?.id}" class="many-to-one"/>
