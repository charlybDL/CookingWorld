			...
			<ol class="property-list recette">
				...
				<li class="fieldcontain">
					<span id="photo-label" class="property-label"><g:message code="recette.photo.label" default="Photo" /></span>
						...
						<span class="property-value" aria-labelledby="photo-label"><g:fieldValue bean="${recetteInstance}" field="photo"/></span>
				...
				<g:if test="${recetteInstance?.utilisateur}">
				<li class="fieldcontain">
					<span id="utilisateur-label" class="property-label"><g:message code="recette.utilisateur.label" default="Utilisateur" /></span>
					
						<span class="property-value" aria-labelledby="utilisateur-label"><g:link controller="utilisateur" action="show" id="${recetteInstance?.utilisateur?.id}">${recetteInstance?.utilisateur?.encodeAsHTML()}</g:link></span>
