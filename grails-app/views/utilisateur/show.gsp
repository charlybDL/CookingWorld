...
<div id="show-utilisateur" class="content scaffold-show" role="main">
    ...
    <ol class="property-list utilisateur">
        ...
        <g:if test="${utilisateurInstance?.motDePasse}">
            <li class="fieldcontain">
                <span id="motDePasse-label" class="property-label"><g:message code="utilisateur.motDePasse.label"
                                                                              default="Mot De Passe"/></span>

                <span class="property-value" aria-labelledby="motDePasse-label"><g:fieldValue
                        bean="${utilisateurInstance}" field="motDePasse"/></span>
